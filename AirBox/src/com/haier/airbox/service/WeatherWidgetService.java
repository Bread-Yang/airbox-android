...
package com.haier.airbox.service;
...
import com.haier.airbox.provider.WeatherContentProvider;
import com.haier.airbox.provider.WeatherWidgetProvider;
...
class StackRemoteViewsFactory implements RemoteViewsService.RemoteViewsFactory {
	...
	public RemoteViews getViewAt(int position) {
		...
		if (mCursor.moveToPosition(position)) {
			final int dayColIndex = mCursor
					.getColumnIndex(WeatherContentProvider.Columns.DAY);
			final int tempColIndex = mCursor
					.getColumnIndex(WeatherContentProvider.Columns.TEMPERATURE);
		...
		rv.setTextViewText(R.id.widget_item,
				String.format(formatStr, temp, day));

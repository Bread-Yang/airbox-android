...
package com.haier.airbox.provider;
...
import com.haier.airbox.R;
import com.haier.airbox.service.WeatherWidgetService;
...
public class WeatherWidgetProvider extends AppWidgetProvider {
    public static String CLICK_ACTION = "com.haier.airbox.provider.WeatherWidgetProvider.CLICK";
    public static String REFRESH_ACTION = "com.haier.airbox.provider.WeatherWidgetProvider.REFRESH";
    public static String EXTRA_DAY_ID = "com.haier.airbox.provider.WeatherWidgetProvider.day";
    ...
    public void onEnabled(Context context) {
    	Log.e("onEnabled()被调用了", "onEnabled()被调用了");
        ...
        if (sDataObserver == null) {
            ...
            r.registerContentObserver(WeatherContentProvider.CONTENT_URI, true, sDataObserver);
        }
    }

    @Override
    public void onReceive(Context ctx, Intent intent) {
    	Log.e("onReceive()被调用了", "onReceive()被调用了");
        ...
        if (action.equals(REFRESH_ACTION)) {
            ...
            sWorkerQueue.post(new Runnable() {
                ...
                public void run() {
                    final ContentResolver r = context.getContentResolver();
                    final Cursor c = r.query(WeatherContentProvider.CONTENT_URI, null, null, null, 
                            null);
                    ...
                    for (int i = 0; i < count; ++i) {
                        final Uri uri = ContentUris.withAppendedId(WeatherContentProvider.CONTENT_URI, i);
                        final ContentValues values = new ContentValues();
                        values.put(WeatherContentProvider.Columns.TEMPERATURE,
    ...
    private RemoteViews buildLayout(Context context, int appWidgetId, boolean largeLayout) {
        ...
        if (largeLayout) {
            ...
            Cursor c = context.getContentResolver().query(WeatherContentProvider.CONTENT_URI, null,
                    null, null, null);
            if (c.moveToPosition(0)) {
                int tempColIndex = c.getColumnIndex(WeatherContentProvider.Columns.TEMPERATURE);
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
    	Log.e("onUpdate()被调用了", "onUpdate()被调用了");
    ...
    public void onAppWidgetOptionsChanged(Context context, AppWidgetManager appWidgetManager,
    	...
    	Log.e("onAppWidgetOptionsChanged()被调用了", "onAppWidgetOptionsChanged()被调用了");
